...
export class VanillaBarcodeScanner {
  constructor(options = {}) {
  ...
  async init() {
    try {
      ...
      this.api = {
        scan_image: this.module.cwrap("scan_image", "", [
          "number",
          "number",
          "number",
        ]),
        create_buffer: this.module.cwrap("create_buffer", "number", [
          "number",
          "number",
        ]),
...
// Default export
export default VanillaBarcodeScanner;
